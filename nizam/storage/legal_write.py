    ...
    with connect() as conn, conn.cursor() as cur:
        ...
        if inst.toc_entries:
            with cur.copy("COPY instrument_toc_entry "
                          ...
                          " entry_kind, source_block_id, source_page, provision_id, match_method) "
                          "FROM STDIN") as cp:
        ...
        for inst in sorted(insts, key=lambda value: value.expression_ordinal):
            ...
            if inst.toc_entries:
                with cur.copy("COPY instrument_toc_entry "
                              ...
                              "source_block_id,source_page,provision_id,match_method) FROM STDIN") as cp:
                    for entry in inst.toc_entries:
                        ...
                        cp.write_row((instrument_id,entry["ordinal"],entry["label"],
                                      ...
                                      entry.get("source_block_id"),entry.get("source_page"),
